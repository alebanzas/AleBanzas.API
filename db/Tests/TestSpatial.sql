...
ALTER DATABASE ABServicios
SET COMPATIBILITY_LEVEL = 110;
GO


DECLARE @gg geography = 'POLYGON((-122.358 47.653, -122.348 47.649, -122.348 47.658, -122.358 47.658, -122.358 47.653))';
SELECT @gg.STIntersection('FULLGLOBE').ToString(), @gg.STIntersection('FULLGLOBE');
