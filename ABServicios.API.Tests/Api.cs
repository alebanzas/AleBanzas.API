...
namespace ABServicios.API.Tests
{
	public static class Api
	{
		...
		{
			var ub = new UriBuilder("http", "servicio.abhosting.com.ar");
		...
		public static IEnumerable<MediaTypeFormatter> GetContentFormatters()
		{
			...
			// no entendí el motivo por el cual los mediatype mapping no funcionan en el HttpClient mientras hay que tocarle si o si los SupportedMediaTypes o así parece
